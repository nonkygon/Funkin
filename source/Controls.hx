...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		{
			case Solo:
				inline bindKeys(Control.UP, [N, W, FlxKey.UP]); // added my own personal keybinds to the defaults lol
				inline bindKeys(Control.DOWN, [X, S, FlxKey.DOWN]);
				inline bindKeys(Control.LEFT, [Z, A, FlxKey.LEFT]);
				inline bindKeys(Control.RIGHT, [M, D, FlxKey.RIGHT]);
